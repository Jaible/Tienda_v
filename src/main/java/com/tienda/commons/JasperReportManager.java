...
public class JasperReportManager {
    ...
    public ByteArrayOutputStream export(String filename, String tipoReporte, 
            Map<String, Object> params, Connection con) throws JRException, IOException {
        ...
        if(tipoReporte.equalsIgnoreCase(TipoReportEnum.EXCEL.toString())){
